...
#define STRING_CONFIG_H_AUTHOR "(aks)" // Who made the changes.
...
#define DELTA
  ...
  #define DELTA_HEIGHT 288.5 // get this value from auto calibrate

  #define DELTA_ENDSTOP_ADJ { 0.0, 0.0, 0.0 } // get these from auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 134.4 //mm  99.4 Get this value from auto calibrate
...
// from orginal anycubic firmware
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { XYZ_STEPS, XYZ_STEPS, XYZ_STEPS, 96 }
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -24.4  // height of V2 probe from the switch bottom to nozzle
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define UBL_MESH_INSET 50         // Mesh inset margin on print area
...
// Preheat Constants
#define PREHEAT_1_TEMP_HOTEND 180 // PLA
#define PREHEAT_1_TEMP_BED    40
#define PREHEAT_1_FAN_SPEED   255 // Value from 0 to 255

#define PREHEAT_2_TEMP_HOTEND 250 // HIPS/ABS
